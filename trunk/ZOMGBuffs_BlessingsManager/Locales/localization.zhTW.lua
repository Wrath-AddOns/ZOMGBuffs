...
L:RegisterTranslations("zhTW", function() return {
	...
	["HELP_TITLE"] = "祝福管理器幫助",
	["HELP_TEXT"] =
		"祝福管理器有兩種模式。默認模式只是簡單地顯示團隊裏每個聖騎士的祝福配置。配置模式允許你設置每個職業的默認祝福，而不管有沒有騎士存在。這些預設值在普通模式下點擊“生成”按鈕時會自動分配。\r\r"..
		"聖騎士列表顯示了他們的名字以及一些相關資訊例如以圖示形式顯示的有效祝福，天賦配置，以及ZOMGBuffs版本\r\r"..
		"|cFFFF8080紅色圖示|r表明了一個有衝突的Buff。\r|cFF8080FF藍色圖示|r表明了這個格子例外。\r\r"..
		"|cFFFFFFFF普通模式|r\r"..
		"|cFFFFFF80滑鼠左鍵|r點擊一個圖示會為那個職業在那個騎士所擁有的祝福之間迴圈切換。\r"..
		"|cFFFFFF80滑鼠右鍵|r點擊一個圖示會為單個玩家設立一個例外。意思是說，假設所有的德魯伊都被Buff完強效智慧祝福後，你可能會有一個野德需要Buff力量祝福取代智慧祝福。\r\r"..
		"|cFFFFFFFF配置模式|r\r"..
		"在這個模式下，重要的是要認識到祝福的順序表明了在任何Raid中可能出現的騎士的數量。假如設置正確，你應該很少會更改這個配置。因此，假設你只有一名騎士在團隊中，自動分配的祝福方案將來自于第一行，兩名騎士的話，將使用第一行和第二行，以此類推。\r\r"..
		"|cFFFFFF80滑鼠左鍵|r點擊一個圖示會為那個職業在那一行的祝福之間迴圈切換。\r\r"..
		"滑鼠劃過某個具有次級職業定義的職業將會展開以顯示次級職業，以同樣的方式設置這些職業。注意次級職業分離視窗同樣也會打開，以便將玩家移動到屬於他們正確的次級職業欄位中去。\r\r"..
		"|cFFFFFFFF配置按鈕|r\r"..
		"在兩個模式之間切換（普通和配置模式）。\r\r"..
		"|cFFFFFFFF生成按鈕|r\r"..
		"以全局範本自動分配當前的聖騎士，同時還檢查天賦設置，因此例如擁有強化力量祝福天賦的騎士將會被優先分配Buff力量祝福。\r\r"..
		"|cFFFFFFFF群發按鈕|r\r"..
		"將當前的祝福配置重新群發一遍，用在某人掉線重新登錄魔獸這樣的情況上。\r\r",
	["Warning!"]								= "警告！",
	["PallyPower users are in the raid and you are NOT promoted\rPallyPower only accepts assignment changes from promoted players"] = "團隊裏有PallyPower用戶，而你不是團隊助理\rPallyPower只接受助理以上的玩家的分配",
