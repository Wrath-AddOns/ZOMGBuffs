...
--@end-debug@]===]
{
	...
	["Not When Shapeshifted"] = "Nicht wenn Formwandlung aktiv", -- Needs review
	["Not When Stealthed"] = "Nicht wenn getarnt", -- Needs review
	Notice = "Hinweis",
	...
	Party = "Gruppe",
	["Perform extra checks for pets in case any missed the group buffs when they were done"] = "Führe zusätzliche Prüfung für Pets aus, falls eines keine Gruppenstärkung bekam nachdem diese geschehen sind", -- Needs review
	...
	["Route notification messages through SinkLib"] = "Benachrichtigungen über SinkLib leiten", -- Needs review
